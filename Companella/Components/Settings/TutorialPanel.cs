...
public partial class TutorialPanel : CompositeDrawable
{
	...
	private Container CreateSection(string title, string description, string buttonText, Color4 buttonColor,
		out TutorialPanelButton button)
	{
					...
					Children = new Drawable[]
					{
						...
						new FillFlowContainer
						{
							...
							Children = new Drawable[]
							{
								...
								CreateClickableLinkRow("Visit the ", "osu! Forum Thread",
									"https://osu.ppy.sh/community/forums/topics/2168176", " to ask questions"),
