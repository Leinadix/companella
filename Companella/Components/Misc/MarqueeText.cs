...
public partial class MarqueeText : CompositeDrawable
{
	...
	private const float _scrollSpeed = 50f; // Pixels per second
	private const double _pauseDuration = 2000; // Milliseconds to pause at each end

	private string _text = string.Empty;
	private FontUsage _font = new("", 15);
			...
			case MarqueeState.ScrollLeft:
				{
					...
					_scrollOffset += (float)(_scrollSpeed * elapsed / 1000.0);
