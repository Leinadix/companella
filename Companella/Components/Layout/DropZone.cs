...
public partial class DropZone : CompositeDrawable
{
	...
	private readonly Color4 _normalColor = new(35, 35, 40, 255);
	private readonly Color4 _hoverColor = new(50, 50, 60, 255);
	private readonly Color4 _borderNormalColor = new(80, 80, 90, 255);
	private readonly Color4 _borderActiveColor = new(255, 102, 170, 255);
