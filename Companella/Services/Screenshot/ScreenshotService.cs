...
public static class ScreenshotService
{
    ...
    public static void CaptureDrawable(Drawable drawable, IWindow? window = null)
    {
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    handle = FindWindow(null, "Companella! - Training Mode");
                }
            ...
            Logger.Info($"[Screenshot] Window at ({windowX}, {windowY}), drawable at ({screenSpaceQuad.TopLeft.X}, {screenSpaceQuad.TopLeft.Y})");
    ...
    public static void CaptureRegion(System.Drawing.Rectangle region)
    {
        try
        {
    ...
    private static void CopyBitmapToClipboard(System.Drawing.Bitmap bitmap)
    {
        ...
        var bitmapCopy = new System.Drawing.Bitmap(bitmap);
