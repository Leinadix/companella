...
public class OsuFileParser
{
	...
	public static OsuFile Parse(string filePath)
	{
	...
	private static void ParseGeneralLine(OsuFile osuFile, string line)
	{
	...
	private static void ParseMetadataLine(OsuFile osuFile, string line)
	{
		var colonIndex = line.IndexOf(':');
		if (colonIndex < 0)
			return;
	...
	private static void ParseDifficultyLine(OsuFile osuFile, string line)
	{
		var colonIndex = line.IndexOf(':');
		if (colonIndex < 0)
			return;
	...
	[SuppressMessage("", "CA1310")]
	private static void ParseTimingPointLine(OsuFile osuFile, string line)
	{
		// Skip comments
		if (line.StartsWith("//"))
			return;
