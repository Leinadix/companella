...
public class AudioExtractor
{
	...
	/// </summary>
	public static string GetAudioPath(OsuFile osuFile)
	{
	...
	/// </summary>
	public static bool ValidateAudioFile(OsuFile osuFile)
	{
		if (string.IsNullOrEmpty(osuFile.AudioFilename))
			return false;
	...
	/// </summary>
	public static string GetAudioExtension(OsuFile osuFile)
	{
