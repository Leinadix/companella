...
public class BeatmapIndexer
{
	...
	public static string? CreateIndexedCopy(string originalPath, int index)
	{
	...
	/// </summary>
	private static string GenerateIndexedFilename(string originalFilename, int index, string originalVersion,
		string newVersion)
	{
	...
	public static void CleanupIndexedCopies(string directory, string? pattern = null)
	{
	...
	public static List<string> CreateIndexedCopies(IEnumerable<string> beatmapPaths)
	{
