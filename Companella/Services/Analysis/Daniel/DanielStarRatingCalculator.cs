...
{
	internal sealed class StarRatingResult
	{
	...
	internal static StarRatingResult Calculate(DanielPreprocessResult preprocess)
	{
		...
		var totalNotes = noteSeq.Count;
		sr *= totalNotes / (double)(totalNotes + 60);
