...
public class BulkRatePreset
{
    ...
    /// </summary>
    public BulkRatePreset(string name, double minRate, double maxRate, double step, double? od = null, double? hp = null, bool excludeBaseRate = false)
    {
        Name = name;
        MinRate = minRate;
        MaxRate = maxRate;
    ...
    /// </summary>
    public string GetSubtitle() => $"{MinRate}x - {MaxRate}x";

    /// <summary>
    /// Gets a tooltip description.
    /// </summary>
    public string GetTooltip() => $"Create rates from {MinRate}x to {MaxRate}x with {Step} step";
}
