...
public class MarathonEntry
{
	...
	/// </summary>
	public string MsdDisplay => IsPause
		? ""
		: MsdValues != null
			? $"{MsdValues.Overall:F1} {MsdValues.Stream:F1} {MsdValues.Jumpstream:F1} {MsdValues.Handstream:F1} {MsdValues.Stamina:F1} {MsdValues.Jackspeed:F1} {MsdValues.Chordjack:F1} {MsdValues.Technical:F1} "
			: "--";
	...
	private static double CalculateDominantBpm(List<TimingPoint> timingPoints)
	{
		...
		// Find BPM with the longest duration
