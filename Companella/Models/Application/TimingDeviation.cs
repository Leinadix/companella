...
public class TimingDeviation
{
	...
	{
		var threshold = judgementWindow * rate;
...
public class TimingAnalysisResult
{
	...
	public void CalculateStatistics()
	{
		...
		var sumSquaredDiff = Deviations.Sum(d => Math.Pow(d.Deviation - MeanDeviation, 2));
		var stdDev = Math.Sqrt(sumSquaredDiff / Deviations.Count);
