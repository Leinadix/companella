...
public class EnumModParameter<T> : IModParameter where T : struct, Enum
{
    ...
    {
        if (_displayNames.TryGetValue(value, out var name))
        {
            return name;
        }
    ...
    public void SetValue(object value)
    {
        ...
        else if (value is int intValue)
        {
            ...
            if (intValue >= 0 && intValue < _allowedValues.Length)
            {
                Value = _allowedValues[intValue];
            }
        }
    ...
    /// <inheritdoc />
    public object? GetMinValue() => null;

    /// <inheritdoc />
    public object? GetMaxValue() => null;

    /// <inheritdoc />
    public object? GetStep() => null;
    ...
    public double GetNormalizedValue()
    {
        ...
        if (index < 0) return 0;
        if (_allowedValues.Length <= 1) return 0;
    ...
    /// <inheritdoc />
    public string GetDisplayValue() => GetDisplayName(Value);
